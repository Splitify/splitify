...
export default function (props: {
  ...
  useEffect(() => {
    ...
    setChecked(isChecked)}, [tracks, props.checked, props.id]
  )
            ...
            >
              <Grid>
                {tracks ? (
                  <div>
                  <Grid item>
                    <Checkboxes id={props.id} toggleChecked={props.toggleChecked} isDeletable={props.isDeletable} track={tracks[0]}/>
                  </Grid>
                  <Grid item>
                    <>
                                ...
                                <ListItemSecondaryAction>
                                    <ListItemIcon>
                                      <DragHandleIcon />
													...
													return (<Track track={track} isDragging={snapshot.isDragging} />)
                      }
                    })}
                    </>
                  </Grid>
