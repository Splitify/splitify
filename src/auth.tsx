...
export default new (class {
  ...
  generateEndpoint () {
    ...
    let data = {
      ...
      response_type: 'token',
      scope: 'playlist-read-private playlist-read-collaborative playlist-modify-private playlist-read-collaborative playlist-read-private playlist-modify-public'
    }
